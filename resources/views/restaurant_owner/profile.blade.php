        ...
        @if ($restaurant != null)
            <div class="page rounded-3 bg-white p-3 "
                ...
                <div class="my-5">
                    ...
                    <p style="display: flex;justify-content: center;"
                        class="rounded-pill border border-success border-2 mx-5 ">
                        <strong>Restaurant Number:</strong>&nbsp;
                    </p>
                    <p style="display: flex;justify-content: center;"
                        class="rounded-pill border border-success border-2 mx-5 ">
                        <strong>Restaurant Account Number:</strong>&nbsp;
                    </p>
                </div>
            </div>
            ...
            <div class="page rounded-3 bg-white py-3 px-5 my-5"
                ...
                <div class="my-5">
                    <form method="POST">
                        ...
                        <button type="submit" class="btn btn-primary my-2">Update Restaurant Profile</button>
            ...
            <div class="page rounded-3 bg-white py-3 px-5 my-5"
                ...
                <div class="my-5">
                    <form method="post">
                        ...
                        <button name="create" type="submit" class="btn btn-primary my-2">Create Restaurant Profile</button>
                        <small class="mx-3 text-danger">All the users gonna see submited profile</small>
                    </form>
                </div>
            </div>
