...
<!--Get your own code at fontawesome.com-->
        ...
        <link href="{{ asset('css/admin_panel/app.css') }}" rel="stylesheet" type="text/css" >
    ...
    <body class="antialiased">
        <i class='fas fa-pizza-slice' style='font-size:36px'></i>
        <img src="https://www.google.com/url?sa=i&url=https%3A%2F%2Fsvgsilh.com%2Fimage%2F1904494.html&psig=AOvVaw0PSbmg8eVg52aRpRc01c9V&ust=1682525527926000&source=images&cd=vfe&ved=0CA4QjRxqFwoTCKid2J-2xf4CFQAAAAAdAAAAABAD" class="img-fluid ${3|rounded-top,rounded-right,rounded-bottom,rounded-left,rounded-circle,|}" alt="">
        {{-- <svg> https://www.google.com/url?sa=i&url=https%3A%2F%2Fsvgsilh.com%2Fimage%2F1904494.html&psig=AOvVaw0PSbmg8eVg52aRpRc01c9V&ust=1682525527926000&source=images&cd=vfe&ved=0CA4QjRxqFwoTCKid2J-2xf4CFQAAAAAdAAAAABAD</svg> --}}
        <svg style="display:none;">
          ...
          <header class="page-header">
            <nav>
              <a href="#" class="logo">
                <img src="https://svgsilh.com/svg/2085075.svg" alt="logo" srcset="" style="width: 70px;height:70px;aspect-ratio:3/2;object:contain;mix-blend-mode:color-burn">
                <p>SnappFood</p>
              </a>
